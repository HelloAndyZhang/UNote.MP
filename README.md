...
1. 微信、支付宝、webApp小程序打通ATS活动平台。形成（参与活动、发送奖励、使用奖励）完整的活动体系，配合城市进行用户拉新转化过程。
2. 支付宝小程序优化操作体验，经过调研目前支付宝小程序打开速度满意度在60%左右，预计优化之后用户满意度可在75%左右。
3. 体验、拉新效果较好的活动，前端可针对此类活动结合我们使用场景进行开发。




---
title: Taro框架介绍及安装及使用说明
---
